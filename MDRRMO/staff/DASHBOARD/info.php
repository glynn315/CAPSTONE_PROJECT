<?php
	...
	$ses_sql = mysqli_query($db,"SELECT * from emp_tbl where emp_id = $login_session");
		...
		<div id="content">
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
		  	...
		  	<div class="container" style="display: inline-flex;">
		  		<div style="width: 30%;">
			  		<?php  echo '<img src="data:image/jpeg;base64,'.base64_encode($row['image'] ).'" style="width:300px;height: 300px; margin-left: 20px;">'?><br>
			  	</div>
