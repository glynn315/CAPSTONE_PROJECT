...
<body>
	...
	<div>
		...
		<table class="table" style="width:80%;text-align: left;margin-top: 50px;" align="center">
	  		...
	  		<tbody>
	  			<?php
				$res = mysqli_query($link, "SELECT request_tbl.request_id,user_tbl.user_fname,user_tbl.user_lname,request_tbl.longitude,request_tbl.latitude,request_tbl.req_status,request_tbl.request_date,user_tbl.user_contact,request_tbl.emer_report,request_tbl.emer_type FROM user_tbl INNER JOIN request_tbl ON request_tbl.user_id = user_tbl.user_id WHERE request_tbl.emer_type = 'Natural Calamity';");
