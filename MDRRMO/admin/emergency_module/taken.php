<?php
	...
	$query ="SELECT request_tbl.request_id,user_tbl.user_fname,user_tbl.user_lname,request_tbl.longitude,request_tbl.latitude,request_tbl.req_status,request_tbl.request_date,user_tbl.user_contact,request_tbl.image,request_tbl.emer_report,request_tbl.emer_type
		FROM user_tbl
			            ...
			            while($row = mysqli_fetch_array($result))  
			               {  
			                    echo "<tr>";
									...
									echo "<td class='align-middle'>"; echo $row["emer_report"]; echo "</td>";
