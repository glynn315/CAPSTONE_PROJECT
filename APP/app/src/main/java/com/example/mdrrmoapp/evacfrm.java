...
public class evacfrm extends AppCompatActivity {
            ...
            public void onResponse(String response) {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(evacfrm.this, error.getMessage().toString(), Toast.LENGTH_LONG).show();
                    }
                });
    ...
    private void showJSONS(String response) {
        ...
        v5.setText(add1.toUpperCase() + " " + add2.toUpperCase());
    }
}